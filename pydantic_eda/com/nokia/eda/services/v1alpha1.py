...
class BridgeDomainList(BaseModel):
    ...
    apiVersion: str
    items: Optional[List[BridgeDomainModel]] = None
    kind: str
...
class BridgeInterfaceList(BaseModel):
    ...
    apiVersion: str
    items: Optional[List[BridgeInterfaceModel]] = None
    kind: str
...
EgressModel2 = EgressModel


EgressModel3 = Egress


EgressModel4 = EgressModel


EgressModel5 = Egress


EgressModel6 = EgressModel
...
IngressModel1 = Ingress


IngressModel2 = IngressModel


IngressModel3 = Ingress


IngressModel4 = IngressModel


IngressModel5 = Ingress


IngressModel6 = IngressModel
...
class IpLoadBalancing(BaseModel):
    """
...
class Ipv4AddressModel(BaseModel):
    ipPrefix: Annotated[
        str, Field(description="Address and mask to use", title="IP Prefix")
    ]
    primary: Annotated[
...
Ipv4AddressModel1 = Ipv4Address


Ipv4AddressModel2 = Ipv4AddressModel
...
Ipv6AddressModel = Ipv4AddressModel


Ipv6AddressModel1 = Ipv6Address


Ipv6AddressModel2 = Ipv4AddressModel


class Ipv6RouterAdvertisement(BaseModel):
...
MultipathModel1 = Multipath


MultipathModel2 = MultipathModel
...
class PrefixItemModel(BaseModel):
    endRange: Annotated[
        Optional[int],
        Field(
...
class RoutedInterfaceList(BaseModel):
    ...
    apiVersion: str
    items: Optional[List[RoutedInterfaceModel]] = None
    kind: str
...
class RouterList(BaseModel):
    ...
    apiVersion: str
    items: Optional[List[RouterModel]] = None
    kind: str
...
class SpecModel14(BaseModel):
    ...
    egress: Annotated[
        Optional[EgressModel5],
        Field(
            description="Manages actions on traffic at Egress.", title="Egress Actions"
        ),
    ] = None
    ingress: Annotated[
        Optional[IngressModel5],
        Field(
            description="Manages actions on traffic at Ingress.",
            title="Ingress Actions",
        ),
    ...
    ipv4Addresses: Annotated[
        Optional[List[Ipv4AddressModel2]],
        Field(
    ...
    ipv6Addresses: Annotated[
        Optional[List[Ipv6AddressModel2]],
        Field(
    ...
    ipv6RouterAdvertisement: Annotated[
        Optional[Ipv6RouterAdvertisement], Field(title="IPv6 Router Advertisement")
    ] = None
...
class SpecModel7(BaseModel):
    ...
    egress: Annotated[
        Optional[EgressModel3],
        Field(
            description="Manages actions on traffic at Egress.", title="Egress Actions"
        ),
    ] = None
    ingress: Annotated[
        Optional[IngressModel3],
        Field(
            description="Manages actions on traffic at Ingress.",
            title="Ingress Actions",
        ),
